...
function listarAuto() {
    ...
    pintar({
        ...
        id: "divTabla",
        cabeceras: [/*"ID",*/ "Patente", "Modelo", "Año", "Color", "Producto"],
        colspan: 3,
        subtabla: false,
        colspanSub: 3,
        propiedades: [/*"ID_Vehiculo",*/ "Patente", "Nombre_Modelo", "Ano_Vehiculo", "Color", "Producto"],
        eliminar: false,
        editar: true,
        seleccionar: false,
        formulario: true,
...
function GuardarDatos() {
    ...
    var url = "Vehiculo/FiltrarVehiculoPatente/?patente=" + patente;
    var raiz = document.getElementById("hdfOculto").value;
    var urlAbsoluta = window.location.protocol + "//" + window.location.host + raiz + url;
...
function SelectB(id) {
    ...
    fetchget(url, function (res) {
        if (res.ID_Vehiculo == 0) {
            ...
            Correcto("Correcto");
            document.location.href = setUrl("Presupuesto/FrmPSelect");
        }
    })
