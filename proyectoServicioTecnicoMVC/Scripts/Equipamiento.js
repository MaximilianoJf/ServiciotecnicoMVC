...
function listar() {
    pintar({
        ...
        id: "divTabla",
        cabeceras: [/*"ID", */ "Equipamiento"],
        colspan: 3,
        subtabla: false,
        colspanSub: 3,
        propiedades: [/*"ID_Marca",*/ "Nombre_Equipamiento"],
        eliminar: true,
        editar: true,
        propiedadId: "ID_Equipamiento"
    }, {
        busqueda: false,
        url: "Marca/filtrar",
...
function GuardarDatos() {
    ...
    var nombre = document.getElementById("txtEquipamiento").value;

    var url = "Equipamiento/VerificarEquipamiento/?nombreEquipamiento=" + nombre;
...
function GuardarDatosValidado() {
    ...
    if (validarDatos() == 0) {
        fetchPostText("Equipamiento/guardarDatos", frm, function (res) {
            if (res == "1") {
                listar();
                Limpiar();
...
function ModificarDatos() {
    ...
    var id = document.getElementById("txtIDEquipamiento").value;
    url = "Equipamiento/RecuperarDatos/?id=" + id;
...
function validarDatos() {
    ...
    if (document.getElementById("txtEquipamiento").value == "") {
        document.getElementById("txtEquipamiento").className = "form-control is-invalid";
        document.getElementById("invalid-Equipamiento").innerHTML = 'Debe ingresar un equipamiento'
        val = 1;
        ...
        if (respuestaNombre.length != 0) {
            val = 1;
            document.getElementById("txtEquipamiento").className = "form-control is-invalid";
            document.getElementById("invalid-Equipamiento").innerHTML = 'El equipamiento que intenta ingresar ya existe'

        } else {

            document.getElementById("txtEquipamiento").className = "form-control is-valid";
        }
    }
...
function validarDatosM() {
    ...
    if (document.getElementById("txtEquipamiento").value == "") {
        ...
        if (respuestaNombre.length != 0) {
            if (respuestaModificar.Nombre_Equipamiento == respuestaNombre[0].Nombre_Equipamiento) {
                document.getElementById("txtEquipamiento").className = "form-control is-valid";
            } else {
                val = 1;
                document.getElementById("txtEquipamiento").className = "form-control is-invalid";
...
function Editar(id) {
    ...
    removeVal()
    recuperarGenerico("Equipamiento/RecuperarDatos/?id=" + id, "formulario");
...
function Eliminar(id) {
    fetchGetText("Equipamiento/EliminarEquipamiento/?id=" + id, function (res) {
        if (res == "1") {
            listar();
